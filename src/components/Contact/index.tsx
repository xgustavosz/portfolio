    ...
    return (
        <ContainerContact id="contato">
            ...
            <SubContainerContact>
                ...
                <BoxContact href='mailto:gugassilva2000@gmail.com' >
                    ...
                    <BoxTexts>
                        <LinkText>gugassilva2000@gmail.com</LinkText>
                    </BoxTexts>
                </BoxContact>

                <BoxContact target="blank" href='https://api.whatsapp.com/send?phone=5553981070940'>
                    ...
                    <BoxTexts>
                        <LinkText>(53) 98107-0940</LinkText>
                    </BoxTexts>
                </BoxContact>
                <BoxCV href={`${process.env.PUBLIC_URL}/meucurriculo.pdf`} download="Currículo - Gustavo Silva">
                    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ContainerSocialMedias>
                    <SocialMedia target="blank" href='https://www.linkedin.com/in/xgustavosz/'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank" href='https://github.com/xgustavosz'>
                        <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SocialMedia target="blank" href='https://www.instagram.com/xgustavosz/'>
